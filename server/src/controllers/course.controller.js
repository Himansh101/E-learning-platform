...
export const getCourse = async(req, res)=>{
    try {
        ...
        const prompt = `You are an intelligent assistant for a learning management platform System . A user is searching for courses. analyze the query and return the most relevant keyword from these categories
        ...
        only reply with one keyword that best matches the query 
        no explanation
...
export const getAllPurchasedCourse = async(req, res)=>{
    try {
        ...
        console.log(error, "from getAllPurchased course");
