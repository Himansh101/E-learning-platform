...
export const generateQuiz = async(req, res)=>{
    try {
        ...
        if(existingQuiz && existingQuiz.questions.length){
            return res.status(201).json({
        ...
        const prompt = `Generate 10 technical quetions for ${content}. Each question should be multiple choice with 4 options. Return the response in this JSON format, and no additional text:
        {
        questions:[
        {
            "question":"String",
        ...
        try {
            ...
            console.log(error, "failed to parse gemini object");
        ...
        console.log(error, "from generate quiz");
